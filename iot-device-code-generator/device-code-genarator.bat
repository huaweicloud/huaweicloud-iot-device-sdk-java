...
call java -jar iot-device-code-generator\target\iot-device-code-generator-1.2.1-with-deps.jar %productZip%
cd generated-demo
call mvn install
call java -jar target\iot-device-demo-ganerated-1.2.1-with-deps.jar %accessAddress% %deviceId% %secret%
pause
