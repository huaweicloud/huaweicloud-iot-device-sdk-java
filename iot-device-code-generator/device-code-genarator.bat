...
call java -jar iot-device-code-generator\target\iot-device-code-generator-1.1.3-with-deps.jar %productZip%
cd generated-demo
call mvn install
call java -jar target\iot-device-demo-ganerated-1.1.3-with-deps.jar %deviceId% %secret%
pause
